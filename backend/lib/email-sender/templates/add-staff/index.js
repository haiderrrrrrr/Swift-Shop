...
>
                                      ...
                                      <tr>
                                        <td style='width:150px;'>
                                          ...
                                          <img
                                            alt
                                            height='auto'
                                            src='https://res.cloudinary.com/ahossain/image/upload/v1676296566/Swift Shop%20files/cc_v8jite.png'
 ...
 <h2>Hello ${option.name}</h2>
    ...
    option.cname
      ...
      <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at contact1swiftshop@gmail.com</p>

     <p style="margin:0px auto; margin-top:40px; text-align:center;">Thank you   <h4 style="margin:1px; margin-bottom:0px; text-align:center;">Swift Shop Team</p></p>
