Swift Shop Server Documentation - Updated backend

Introduction:

This is ready api backend for Swift Shop admin and frontend built with node.js, express, mongoose, and mongodb for database.
...
For getting started with the template you have to follow the below procedure. First navigate to the Swift Shop-server directory.
